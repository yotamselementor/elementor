...
#### 3.13.0-dev2 - 2023-03-14
* Fix: New Swiper Library (v8.45) affects Elementor's Lightbox behavior (#21413) [ED-9856] (#21522)
* Fix: Editor - "Responsive Mode" tooltip in the panel is not aligned [ED-9964] (#21544)
* Fix: 'tagged-based release' github action CORE (syntax & remove tag step) [ED-9977] (#21562)
* Fix: Video widget creating space inside it's wrapper [ED-9809] (#21484)
* Fix: On GA publish, replace "merge to master" and "delete tag" tuning order (Core) [ED-10021] (#21589)
* Fix: Image Carousel - Save as Default breaks the widget in some cases (#21371)[ED-9852] (#21524)
* Fix: Editor V2 - i18n webpack plugin extract translators comments [ED-9972] (#21549)
* Fix: Video Widget - playwright fix. [ED-9809] (#21606)
* Tweak: Improve lightbox accessibility [ED-9975] (#21557)
* New: Grid- infra for Gap control [ED-9760] (#21566)
* Fix: [infra] Dropdown Content's position glitch when using fit to content in Menu widget [ED-10017] (#21590)
* Fix: Latest Chrome release breaks sticky effects [ED-10063] (#21616)
* Tweak: Add a tooltip for using globals [ED-9974] (#21552)
* Tweak: Display text colors after the typography in icons list widget [ED-10050] (#21601)
* Tweak: Added Lazy Load support to various Elementor Editor/Admin images (#21608)
* Tweak: Added Lazy Load support for embedded content thumbnail image [ED-10097] (#21640)
* Tweak: Improved SVG file upload sanitization for better security enforcement [ED-10007] (#21633)
* Tweak: Improved code security enforcement in Text Path widget [ED-10009] (#21631)
* Fix: Template files deleted after cli import [ED-9954] (#21513)
* Fix: Plugins Tester - tests are not running (JS error) & update new face-lift UI [ED-10087] (#21636)
* Tweak: Modify cli commands to support cloud site creation [ED-9953] (#21521)
